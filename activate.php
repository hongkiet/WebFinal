...
if(isset($_GET['token'])){
    ...
    if($result['code']==0){
        ...
        $error = "Có lỗi xảy ra khi kích hoạt tài khoản: ".$result['error'];
    }
}else{
                  ...
                  ?>
                          <div class="row">
                            <div class="col-md-6 mt-5 mx-auto p-3 border rounded">
                                ...
                                <p>Click <a href="main.php">here</a> to login.</p>
                                <a class="btn btn-success px-5" href="main.php">Login</a>
                            </div>
                          </div>
                  <?php
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-md-6 mt-5 mx-auto p-3 border rounded">
                              ...
                              <p>Click <a href="main.php">here</a> to login and manage your account information.</p>
                              <a class="btn btn-success px-5" href="main.php">Login</a>
                          </div>
                        </div>
                  <?php
